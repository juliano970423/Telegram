...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingCell.Factory.of(24, IconBackgroundColors.GREEN.top, IconBackgroundColors.GREEN.bottom, R.drawable.msg_translate, getString(R.string.NllbTranslation), getString(R.string.NllbTranslationInfo)));
    ...
    private void onClick(UItem item, View view, int position, float x, float y) {
        ...
        switch (item.id) {
            ...
            case 10:
                ...
                break;
            case 24:
                presentFragment(new NllbSettingsActivity());
                break;
